...
def start(message):
    try:
        ...
        bot.send_message(message.chat.id, "⚠️ Some error occurred. Please try /start again")
...
def branch_selected_first(message):
    try:
        ...
        bot.send_message(message.chat.id, "⚠️ Error! Please try again.", reply_markup=MenuBuilder.main_menu())
...
def feedback_command(message):
    try:
        ...
        markup.add(
            ...
            InlineKeyboardButton("⭐ Rate 5 Stars", url="https://t.me/EngineersPathwayOfficial"),
            InlineKeyboardButton("💬 Suggest Feature", url=f"https://t.me/EngineersPathwayOfficial")
        )
...
def main_menu_command(message):
    try:
        ...
        menu_text = (
            ...
            "📚 Syllabus - Download semester-wise syllabus\n"
            "📊 Stats - View bot statistics\n"
            "ℹ️ Help - Get usage guide\n"
